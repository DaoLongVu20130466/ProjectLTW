...
<div class="container-form">
  <div class="card text-center" style="width: 300px;">
    ...
    <div class="card-body px-5">
      ...
      %>
      <form onsubmit="return cheking()" name="formreset" id="formreset">
        <div class="form-outline">
          <input name="otp" type="hidden" value=<%newotp.getOtp();%>>
          <input name="otp" type="hidden" value=<%user.getUserId();%>>
...
<script>
  var a = document.forms["formreset"]["name"].value;
  var checking = 0;
  function cheking() {
    if (a == null || a == ""){
  ...
  function checkingOtp() {
    var otp = document.forms["formreset"]["otp"].value;
    if (otp == a){
      document.location.href="/ServResetPass";
    }else if(checking <5)
    {
      checking++;
      showdiaLog("Bạn đã nhập sai otp bạn còn" + checking +"lần thử nữa")
      return false
    }
    else {
      lockuser()
  ...
  function lockuser(){
    showdiaLog("Tài khoản của bạn đã bị khóa")
    document.location.href="/ServletLockThisUser";
  }
  function resetpass(){
    document.location.href="/ServResetPass";
  }
