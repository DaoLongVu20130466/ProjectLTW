            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            <li class="active"><a href="Documents/GitHub/ProjectLTW/BaiNopCuoiKi/web/src/main/webapp/index.jsp">Trang Chủ</a></li>
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li><a href="/user.jsp"><i class="fa fa-user"></i> </a></li>
